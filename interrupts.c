...
{
    IFS0bits.AD1IF = 0;     // Reset interupt flag
//    P1DC1 = P1DC2 = (ADC1BUF0+ADC1BUF1+ADC1BUF2+ADC1BUF3+ADC1BUF4+ADC1BUF5+ADC1BUF6+ADC1BUF7+ADC1BUF8+ADC1BUF9+ADC1BUFA+ADC1BUFB+ADC1BUFC+ADC1BUFD+ADC1BUFE+ADC1BUFF)/16;
}//ADC1Interrupt
*/
...
void __attribute__((interrupt,auto_psv)) _CNInterrupt(void)
 {  
    ...
    // Toggle PWMxH and PWMxL pin
    PWM1CON1bits.PEN1H = !PWM1CON1bits.PEN1H;   
    PWM1CON1bits.PEN1L = !PWM1CON1bits.PEN1L;
    PWM1CON1bits.PEN2H = !PWM1CON1bits.PEN2H;
    PWM1CON1bits.PEN2L = !PWM1CON1bits.PEN2L;
